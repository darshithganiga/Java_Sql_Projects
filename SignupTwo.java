...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno){
        ...
        String relegion[]={"Hindu","Muslim","Christian","Sikh","Other"};
        c1=new JComboBox(relegion);
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway",Font.BOLD,14));
        c1.setBounds(350,120,320,30);
        add(c1);
        
        String category[]={"Genearl","OBC","SC","ST","Other"};
        ...
        String income[]={"Null","<1,50,000","<2,50,000","<5,00,000","upto 10,,00,000","Abpve 10,00,000"};
 ...
 public void actionPerformed(ActionEvent ae){
     String relegion =(String)c1.getSelectedItem();
     ...
     try{
         if (ae.getSource()==b){
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String query = "insert into signupper values('"+formno+"','"+relegion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+eaccount+"')";
